...
<head>
    ...
    <link rel='stylesheet' href='<?php echo e(THEME_ASSET); ?>/asset/metinfo031c.css'>
</head>
<body>
            ...
            <div class="row">
                <div class="navbar-header">
                    ...
                    <a href="index.html" class="navbar-brand navbar-logo vertical-align" title="科技公司">
                        ...
                        <div class="vertical-align-middle"><img src="<?php echo e(THEME_ASSET); ?>/asset/img/1464062976.png"
                                                                alt="科技公司"
                                                                title="科技公司"/>
                        </div>
                    </a>
                ...
                <div class="collapse navbar-collapse navbar-collapse-toolbar nav-shop" id="navbar-default-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right navlist">
                        <?php $__currentLoopData = $GLOBALS['homeMenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <?php if($p->p_id==0): ?>
                                <li class="dropdown margin-left-40">
                                    <a class="dropdown-toggle link <?php if($other['active']==$p->active): ?> active <?php endif; ?>"
                                       data-toggle="dropdown"
                                       data-hover="dropdown"
                                       href="<?php echo e(url($p->route)); ?>"
                                       <?php if($p->target==2): ?>
                                       target="_blank"
                                       <?php endif; ?>
                                       aria-expanded="false"
                                       title="<?php echo e(home_language($p->language_key)); ?>"
                                    ><?php echo e(home_language($p->language_key)); ?>

                                        <?php $__currentLoopData = $GLOBALS['homeMenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $span): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <?php if($span->p_id==$p->id): ?>
                                    ...
                                    <?php $__currentLoopData = $GLOBALS['homeMenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $span): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <?php if($span->p_id==$p->id): ?>
                                            <ul class="dropdown-menu dropdown-menu-right animate">
                                                ...
                                                <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                <?php $__currentLoopData = $GLOBALS['homeMenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                    <?php if($s->p_id==$p->id): ?>
                                                        <li>

                                                            <a href="<?php echo e(url($s->route)); ?>"
                                                               class=""

                                                               title="<?php echo e(home_language($s->language_key)); ?>"><?php echo e(home_language($s->language_key)); ?></a>
                                                        </li>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                <?php $__currentLoopData = $GLOBALS['homeMenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $span): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
<?php $__env->startSection('banner'); ?>
    <div class="met-banner" data-height='' style=''>
        ...
        <div class="slick-slide">
            <img class="cover-image" src="<?php echo e(THEME_ASSET); ?>/asset/img/1464083856.png"
                 srcset='include/thumb.php?dir=upload/201605/1464083856.png&x=767 767w,<?php echo e(THEME_ASSET); ?>/asset/img/1464083856.png'
        ...
        <div class="slick-slide">
            <img class="cover-image" src="<?php echo e(THEME_ASSET); ?>/asset/img/1464084575.png"
                 srcset='include/thumb.php?dir=upload/201605/1464084575.png&x=767 767w,<?php echo e(THEME_ASSET); ?>/asset/img/1464084575.png'
                            ...
                            <a href="product/showproductb1b6.html?lang=cn&amp;id=48" title="Apple Watch Sport"
                               target='_self'>
                                <img class="cover-image"
                                     src="<?php echo e(THEME_ASSET); ?>/asset/img/thumb.jpg"
...
<?php echo $__env->yieldSection(); ?>
<?php $__env->startSection('footnav'); ?>
...
<script src="<?php echo e(THEME_ASSET); ?>/asset/metinfo3a5b.js?2017011801"></script>
</body>
