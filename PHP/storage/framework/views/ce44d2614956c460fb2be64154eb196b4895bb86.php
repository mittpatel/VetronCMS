                ...
                <div id="panel-1" class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <ul class="options pull-right list-inline">
                            ...
                            <li>
                                <a href="<?php echo e(url('admin/article/category/add')); ?>" style="margin-top: 5px;"
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table" id="datatable_sample">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(admin_language('common_createTime')); ?></th>
                                <th style="width: 200px;"><?php echo e(admin_language('common_action')); ?></th>
                            </tr>
                            </thead>
                            ...
                            <?php $__currentLoopData = $categoryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryListVal): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="<?php echo e(url('admin/article/category/edit'.'/'.$categoryListVal->id)); ?>"
...
<script>
    function deleteCategory(id) {
        layer.confirm('<?php echo e(admin_language('common_areYouDelete')); ?>？', {
            ...
            window.location = "<?php echo e(url('admin/article/category/delete')); ?>" + "/" + id
        });
    }
</script>
</body>
