                ...
                <div id="panel-1" class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <ul class="options pull-right list-inline">
                            ...
                            <li>
                                <a href="<?php echo e(url('admin/article/add')); ?>" style="margin-top: 5px;"
                    ...
                    <div class="table-responsive" style="overflow-x: hidden;">
                        <table class="table table-striped table-hover table-bordered dataTable no-footer"
                            ...
                            <tbody>
                            <?php $__currentLoopData = $articleList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articleListVal): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr class="odd gradeX">
                                    <td style="width: 100px;overflow: hidden;">
                                        <img style="height: 39px;"
                                             src="<?php echo e(asset(explode(',',$articleListVal->cover)[0])); ?>" alt="">
                                    </td>

                                    <td>
                                        <?php echo e($articleListVal->title); ?>

                                    </td>
                                    <td>
                                        <?php echo e(getArticleCategoryName($articleListVal->category)); ?>

                                    </td>
                                    <td>

                                        <?php if($articleListVal->status==1): ?>
                                    ...
                                    <td>
                                        <?php echo e($articleListVal->created_at); ?>

                                    </td>

                                    <td>
                                        <a href="<?php echo e(url('admin/article/edit'.'/'.$articleListVal->id)); ?>"
                                           class="btn btn-success btn-xs white"><i
                                                    class="fa fa-edit white"></i>
                                           <?php echo e(admin_language('common_edit')); ?>

                                        </a>
                                        <a onclick="deleteCategory(<?php echo e($articleListVal->id); ?>)" href="javascript:;"
