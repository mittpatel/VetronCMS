                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form method="post" id="categoryForm">
                                    <fieldset>
                                        {{csrf_field()}}
                                        <input type="hidden" name="id" value="{{$attributeTypeOne->id}}">
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <input onchange="checkLangKeyOnly($(this).val(),2,this)"
                                                           ...
                                                           value="{{$attributeTypeOne->language_key}}"
                                                           val="1"
                                                    ...
                                                    <div style="display: none;" class="languageVal">
                                                        @foreach($language as $l)
                                                            <input placeholder="{{admin_language($l->language_key)}}"
                                                                   ...
                                                                   name="lang[{{$l->folder}}]"
                                                                   value="{{language_all($attributeTypeOne->language_key,'home',$l->folder)}}"
                                                                   class="form-control required">
                                                        @endforeach
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <label class="radio">
                                                        <input type="radio" name="input_type" value="1"
                                                               @if($attributeTypeOne->input_type==1) checked="checked" @endif >
                                                        <i></i>{{admin_language('product_textBox')}}
                                                    </label>
                                                    <label class="radio">
                                                        <input type="radio" name="input_type" value="2"
                                                               @if($attributeTypeOne->input_type==2) checked="checked" @endif >
                                                        <i></i>{{admin_language('product_radio')}}
                                                    </label>
                                                    <label class="radio">
                                                        <input type="radio" name="input_type" value="3"
                                                               @if($attributeTypeOne->input_type==3) checked="checked" @endif >
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <input onchange=""
                                                           ...
                                                           value="{{$attributeTypeOne->default_val}}"
                                                           val="1"
                                                           class="form-control required">
                                                </div>
                                            </div>
