                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <form method="post" id="addArticle" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <input type="text" name="name" value="{{$productOne->name}}"
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <input type="text" name="price" value="{{$productOne->price}}"
                                                               class="form-control required">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <textarea class="form-control" rows="5"
                                                                  name="describe">{{$productOne->describe}}</textarea>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <textarea name="content"
                                                                  id="editor">{!! $productOne->content !!}</textarea>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <input type="text" name="seo[keyword]"
                                                               value="{{json_decode($productOne->seo)->keyword}}"
                                                               class="form-control required">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <input type="text" name="seo[describe]"
                                                               value="{{json_decode($productOne->seo)->describe}}"
                                                               class="form-control required">
                                                    </div>
                                                </div>
                                            </div>
                                                                    ...
                                                                    <li id="a{{$productCategoryVal->id}}"
                                                                        ...
                                                                        <label class="checkbox">
                                                                            ...
                                                                            <input type="checkbox"
                                                                                   onchange=""
                                                                                   name="category[]"
                                                                                   @if(in_array($productCategoryVal->id,explode(',',$productOne->category))) checked
                                                                                   @endif value="{{$productCategoryVal->id}}">
                                                                            <i></i>
                                                                            {{$productCategoryVal->language_key}}
                                                                        </label>
                                                                    </li>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        @foreach(explode(',',$productOne->cover) as $value)
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <div class="gallery-box" style="width: 100%;">
                                                            @if($productOne->gallery)
                                                                @if(count(explode(',',$productOne->gallery))>0)
                                                                    @foreach(explode(',',$productOne->gallery) as $value)
                                                                        <div style="width:50%;position: relative;display: inline-block;float: left;">
                                                                            <img style="width: 98%;margin-bottom: 10px;margin-right: 2%;"
                                                                                 src="{{asset($value)}}"><span
                                                                                    onclick="removeGalleryOne(this)"
                                                                                    style="position: absolute;top: -8px;right: 4px;color: red;font-size: 24px;cursor: pointer;">X</span>
                                                        ...
                                                        <button type="button"
                                                                ...
                                                                class="btn btn-primary btn-sm btn-block">{{admin_language('common_onlineResources')}}
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <input type="hidden" value="{{$productOne->id}}" name="id">
                                        <input type="hidden" name="oldCategoryId" value="{{$productOne->category}}">
                                        {{csrf_field()}}
...
//        $(this).parent(".selectAttribute").
    ...
    $.ajax({
        type: 'post',
        url: "{{url('admin/product/add/attribute/add')}}" ,
        data: {id:{{$productOne->id}},_token:"{{csrf_token()}}"},
        success: function (data) {
            $(".attribute-box").html(data);
        }
    });
