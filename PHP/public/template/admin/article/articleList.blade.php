                ...
                <div id="panel-1" class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <ul class="options pull-right list-inline">
                            ...
                            <li>
                                <a href="{{url('admin/article/add')}}" style="margin-top: 5px;"
                    ...
                    <div class="table-responsive" style="overflow-x: hidden;">
                        <table class="table table-striped table-hover table-bordered dataTable no-footer"
                            ...
                            <tbody>
                            @foreach($articleList as $articleListVal)
                                <tr class="odd gradeX">
                                    <td style="width: 100px;overflow: hidden;">
                                        <img style="height: 39px;"
                                             src="{{asset(explode(',',$articleListVal->cover)[0])}}" alt="">
                                    </td>

                                    <td>
                                        {{$articleListVal->title}}
                                    </td>
                                    <td>
                                        {{getArticleCategoryName($articleListVal->category)}}
                                    </td>
                                    <td>

                                        @if($articleListVal->status==1)
                                    ...
                                    <td>
                                        {{$articleListVal->created_at}}
                                    </td>

                                    <td>
                                        <a href="{{url('admin/article/edit'.'/'.$articleListVal->id)}}"
                                           class="btn btn-success btn-xs white"><i
                                                    class="fa fa-edit white"></i>
                                           {{admin_language('common_edit')}}
                                        </a>
                                        <a onclick="deleteCategory({{$articleListVal->id}})" href="javascript:;"
