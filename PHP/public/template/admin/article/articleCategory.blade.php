                ...
                <div id="panel-1" class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <ul class="options pull-right list-inline">
                            ...
                            <li>
                                <a href="{{url('admin/article/category/add')}}" style="margin-top: 5px;"
                        ...
                        <table class="table" id="datatable_sample">
                            ...
                            @foreach($categoryList as $categoryListVal)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="{{url('admin/article/category/edit'.'/'.$categoryListVal->id)}}"
...
<script>
    function deleteCategory(id) {
        layer.confirm('{{admin_language('common_areYouDelete')}}？', {
            ...
            window.location = "{{url('admin/article/category/delete')}}" + "/" + id
        });
    }
</script>
</body>
