                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form id="addUser">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6">
                                                    ...
                                                    <textarea rows="6" class="form-control"
                                                              name="introduction">{{$userOne->introduction}}</textarea>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="sky-form">
                                                        @foreach($groupList as $groupListVal)
                                                            ...
                                                            <label style="display: inline-block;" class="checkbox">
                                                                <input @if(in_array($groupListVal->id,explode(',',$userOne->g_id))) checked @endif type="checkbox" value="{{$groupListVal->id}}"
                                                                       name="g_id[]"
                                                                       id="drop-remove">
                                    ...
                                    {{csrf_field()}}
                                    <input type="hidden" value="{{$userOne->id}}" name="id">
                                    <input type="hidden" value="{{$userOne->header}}" name="header">
                                </form>
                            </div>
                        </div>
                    </div>
