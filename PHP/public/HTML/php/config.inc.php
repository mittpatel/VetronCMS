...
// Email Subject
$config['subject']				= 'Jellal Contact Form';	// subject of emails you receive
...
define('UPLOAD_FOLDER_URL',	'http://www.ravijaiswal.com/Jellaladmin/mail');	// Full url path to upload folder (used for contact files) - slash at the end!
